...
/*<tr>
<td>User/Admin</td>
<td><input type="taskbar" name="" id="admin" size="30"><admin></td>
<td><input type="taskbar" name="" id="user" size="30"><user></td>
</tr>*/
...
<tr>
<td><input type="Register"></td>
<td colspan="2"><input type="Register" value="Register" /></td>
</tr>

<td>
td colspan="2"><input type="Log In" value="Log In" /></td>
</tr>
</table>
</form>
</body>
